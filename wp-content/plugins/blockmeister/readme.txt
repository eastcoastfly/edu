...
**Announcement: transition to upcoming WP 6.3 core pattern editor**

The WordPress team is planning to release WordPress 6.3 on August 8, 2023. That release will come with features to create and manage custom patterns out of the box. BlockMeister is currently being rewritten to support and enhance these new features! This promises a smooth transition for existing users of BlockMeister, while keeping the extra features like custom categories, keywords, settings and future new features.

We plan to release the new version 4 of BlockMeister very soon after the release date of WP 6.3. 

Note: BlockMeister v4 will require WP 6.3.
